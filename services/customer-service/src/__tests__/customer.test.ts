...
describe('CustomerHandler', () => {
  ...
  test('createCustomer_success', async () => {
    ...
    repository.create.mockResolvedValue(sampleCustomer)
  ...
  test('getCustomer_found', async () => {
    repository.findByDocumentId.mockResolvedValue(sampleCustomer)
  ...
  test('listCustomers_withData', async () => {
    repository.findAll.mockResolvedValue([sampleCustomer])
